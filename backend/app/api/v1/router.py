...
from backend.app.api.v1.endpoints import extraction, findings, health, report, scan, safeshare
...
api_v1_router.include_router(safeshare.router, prefix="/scan", tags=["SafeShare Engine"])
api_v1_router.include_router(safeshare.download_router, prefix="/redaction", tags=["SafeShare Download"])
